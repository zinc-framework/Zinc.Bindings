...
namespace Zinc.Internal.Sokol
{
    ...
    public enum sapp_log_item
    {
        ...
        SAPP_LOGITEM_WIN32_D3D11_GET_IDXGIFACTORY2_FAILED,
        SAPP_LOGITEM_WIN32_D3D11_CREATE_COMPOSITION_SWAPCHAIN_FAILED,
        SAPP_LOGITEM_WIN32_DCOMP_LOAD_DLL_FAILED,
        SAPP_LOGITEM_WIN32_DCOMP_CREATE_DEVICE_FAILED,
        SAPP_LOGITEM_WIN32_DCOMP_CREATE_TARGET_FAILED,
        SAPP_LOGITEM_WIN32_DCOMP_CREATE_VISUAL_FAILED,
        SAPP_LOGITEM_WIN32_COMPOSITEMODE_FELL_BACK_TO_OPAQUE,
    ...
    {
        [NativeTypeName("bool (*)(const void *)")]
