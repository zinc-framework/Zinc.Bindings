...
namespace Zinc.Internal.Sokol
{
    ...
    public static unsafe partial class Gfx
    {
        ...
        public static void setup([NativeTypeName("const sg_desc &")] sg_desc* desc)
        {
            setup(desc);
        }

        public static sg_buffer make_buffer([NativeTypeName("const sg_buffer_desc &")] sg_buffer_desc* desc)
        {
            return make_buffer(desc);
        }

        public static sg_image make_image([NativeTypeName("const sg_image_desc &")] sg_image_desc* desc)
        {
            return make_image(desc);
        }

        public static sg_sampler make_sampler([NativeTypeName("const sg_sampler_desc &")] sg_sampler_desc* desc)
        {
            return make_sampler(desc);
        }

        public static sg_shader make_shader([NativeTypeName("const sg_shader_desc &")] sg_shader_desc* desc)
        {
            return make_shader(desc);
        }

        public static sg_pipeline make_pipeline([NativeTypeName("const sg_pipeline_desc &")] sg_pipeline_desc* desc)
        {
            return make_pipeline(desc);
        }

        public static sg_pass make_pass([NativeTypeName("const sg_pass_desc &")] sg_pass_desc* desc)
        {
            return make_pass(desc);
        }

        public static void update_image(sg_image img, [NativeTypeName("const sg_image_data &")] sg_image_data* data)
        {
            update_image(img, data);
        }

        public static void begin_default_pass([NativeTypeName("const sg_pass_action &")] sg_pass_action* pass_action, int width, int height)
        {
            begin_default_pass(pass_action, width, height);
        }

        public static void begin_default_passf([NativeTypeName("const sg_pass_action &")] sg_pass_action* pass_action, float width, float height)
        {
            begin_default_passf(pass_action, width, height);
        }

        public static void begin_pass(sg_pass pass, [NativeTypeName("const sg_pass_action &")] sg_pass_action* pass_action)
        {
            begin_pass(pass, pass_action);
        }

        public static void apply_bindings([NativeTypeName("const sg_bindings &")] sg_bindings* bindings)
        {
            apply_bindings(bindings);
        }

        public static void apply_uniforms(sg_shader_stage stage, int ub_index, [NativeTypeName("const sg_range &")] sg_range* data)
        {
            apply_uniforms(stage, ub_index, data);
        }

        public static sg_buffer_desc query_buffer_defaults([NativeTypeName("const sg_buffer_desc &")] sg_buffer_desc* desc)
        {
            return query_buffer_defaults(desc);
        }

        public static sg_image_desc query_image_defaults([NativeTypeName("const sg_image_desc &")] sg_image_desc* desc)
        {
            return query_image_defaults(desc);
        }

        public static sg_sampler_desc query_sampler_defaults([NativeTypeName("const sg_sampler_desc &")] sg_sampler_desc* desc)
        {
            return query_sampler_defaults(desc);
        }

        public static sg_shader_desc query_shader_defaults([NativeTypeName("const sg_shader_desc &")] sg_shader_desc* desc)
        {
            return query_shader_defaults(desc);
        }

        public static sg_pipeline_desc query_pipeline_defaults([NativeTypeName("const sg_pipeline_desc &")] sg_pipeline_desc* desc)
        {
            return query_pipeline_defaults(desc);
        }

        public static sg_pass_desc query_pass_defaults([NativeTypeName("const sg_pass_desc &")] sg_pass_desc* desc)
        {
            return query_pass_defaults(desc);
        }

        public static void init_buffer(sg_buffer buf, [NativeTypeName("const sg_buffer_desc &")] sg_buffer_desc* desc)
        {
            init_buffer(buf, desc);
        }

        public static void init_image(sg_image img, [NativeTypeName("const sg_image_desc &")] sg_image_desc* desc)
        {
            init_image(img, desc);
        }

        public static void init_sampler(sg_sampler smp, [NativeTypeName("const sg_sampler_desc &")] sg_sampler_desc* desc)
        {
            init_sampler(smp, desc);
        }

        public static void init_shader(sg_shader shd, [NativeTypeName("const sg_shader_desc &")] sg_shader_desc* desc)
        {
            init_shader(shd, desc);
        }

        public static void init_pipeline(sg_pipeline pip, [NativeTypeName("const sg_pipeline_desc &")] sg_pipeline_desc* desc)
        {
            init_pipeline(pip, desc);
        }

        public static void init_pass(sg_pass pass, [NativeTypeName("const sg_pass_desc &")] sg_pass_desc* desc)
        {
            init_pass(pass, desc);
        }

        public static void update_buffer(sg_buffer buf_id, [NativeTypeName("const sg_range &")] sg_range* data)
        {
            update_buffer(buf_id, data);
        }

        public static int append_buffer(sg_buffer buf_id, [NativeTypeName("const sg_range &")] sg_range* data)
        {
            return append_buffer(buf_id, data);
        }
    }
}
